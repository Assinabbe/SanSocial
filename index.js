...
menuItems.forEach(item => {
    item.addEventListener('click', () => {
        ...
        // Handling notifications display based on item clicked
...
const searchMessages = () => {
    ...
    messagesList.forEach(message => { // Changed 'message' to 'messagesList' for clarity
...
// Event listener for message search input
messageSearch.addEventListener('keyup', searchMessages);

// Event listener for messages notification click
messagesNotification.addEventListener('click', () => {
    // Applying box shadow to messages element
    messages.style.boxShadow = '0 0 1rem var(--color-primary)';
    
    // Hiding notification count after click
    messagesNotification.querySelector('.notification-count').style.display = 'none';
    
    // Resetting box shadow after 2 seconds
    setTimeout(() => {
...
const changeBG = () => {
    root.style.setProperty('--light-color-lightness', lightColorLighness);
